<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeBehind="Employee.aspx.cs" Inherits="WebApplication.Employee" %>
    ...
    <form id="form1" runat="server">
        <div class="container">
            ...
            <div class="form-group">
                <label for="empid_textbox">Employee ID</label>
                <asp:TextBox ID="empid_textbox" runat="server" CssClass="form-control" />
            ...
            <div class="grid-container">
                <asp:GridView ID="employeDataGridView" runat="server" AutoGenerateColumns="True" CssClass="table" Visible="false">
                </asp:GridView>
            </div>
        </div>
    </form>
