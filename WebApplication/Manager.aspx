<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="Manager.aspx.cs" Inherits="WebApplication.Customer" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container">
        ...
        <div class="form-group">
            <label for="customerid_textbox">Manager ID</label>
            <asp:TextBox ID="customerid_textbox" runat="server" CssClass="form-control" />
        ...
        <div class="grid-container">
            <asp:GridView ID="customerDataGridView" runat="server" AutoGenerateColumns="True" CssClass="table" Visible="false">
            </asp:GridView>
        </div>
    </div>
</asp:Content>
